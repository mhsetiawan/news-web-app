                ...
                >
                  <td scope="row" className="px-6 py-4">
                    ...
                    <p className="mt-1 text-blue-600 hover:underline">
                      <Link to={article.web_url}>News Page</Link>
                    </p>
                  </td>
                  ...
                  <td className="px-6 py-4 text-center">
                    <Link
                      ...
                      className="inline-flex items-center bg-red-700 hover:bg-red-800 px-3 py-2 text-xs font-medium text-center text-white rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                      Unsave
                    </Link>
                  </td>
